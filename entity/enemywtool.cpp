...
EnemyWTool::EnemyWTool(u32 min, u32 max) : EnemyWTool(getEnemy(min, max), getTool(min, max)) {}
...
EnemyWTool *EnemyWTool::clone() const { return new EnemyWTool(e->clone(), t->clone()); }
...
bool EnemyWTool::operator==(const EnemyWTool &other) const { return this->e == other.e && this->t == other.t; }
