...
void imageVisitor::visitViolin() { pixmap = new QPixmap(":/assets/violin.png"); }

void imageVisitor::visitTrumpet() { pixmap = new QPixmap(":/assets/trumpet.png"); }
...
void imageVisitor::visitSaxophone() { pixmap = new QPixmap(":/assets/saxophone.png"); }
