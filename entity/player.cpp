...
ThreeColumn::ThreeColumn(u32 health, u32 level)
    : PlayerAbstract(health, level) {}
...
DoubleLife::DoubleLife(u32 health, u32 level, bool secondLife)
    : PlayerAbstract(health, level), secondLife(secondLife) {}
...
ThreeRow::ThreeRow(u32 l)
    : PlayerAbstract(THREE_ROW_HEALTH + THREE_ROW_HEALTH_INCREASE * (l - 1),
                     l) {}
